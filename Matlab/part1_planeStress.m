...
resultPath{1} = '../workspace/lin1_iso';
resultPath{2} = '../workspace/lin1_kin';
resultPath{3} = '../workspace/lin1_mix';
...
print(gcf,'lin1_iso_stress','-depsc')
...
set(gcf, 'PaperPositionMode','auto')
print(gcf,'lin1_kin_stress','-depsc')
...
set(gcf, 'PaperPositionMode','auto')
print(gcf,'lin1_kin_strain','-depsc')
...
set(gcf, 'PaperPositionMode','auto')
print(gcf,'lin1_mix_stress','-depsc')
...
set(gcf, 'PaperPositionMode','auto')
print(gcf,'lin1_mix_strain','-depsc')
...
set(gcf, 'PaperPositionMode','auto')
print(gcf,'lin1_mix_backstress','-depsc')
